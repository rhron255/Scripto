...
def generate_parser(func: FunctionType) -> argparse.ArgumentParser:
    """
    ...
    for param in parameters:
        arg_parser.add_argument(make_kebab_case(param['name']), type=param['type'], help=param['description'])
    return arg_parser
